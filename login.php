	...
	<div class="container-fluid" id='main'>
		...
		<div class="container jumbotron" id='jumb'>
			...
			<div class="col-md-4 col-lg-4 col-sm-10" id='abc'>
				<center>
					<a href="index.php"><img src="logo.png" alt="" style="margin-bottom: -40px;" width="100"
							height="100" /></a>
			...
			?>
				...
				?>
					...
					<p style="font-size:16px; font-style:bold;color:white;text-align: center;">Do not an account? <a
