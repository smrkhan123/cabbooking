        ...
        <table class="container table table-striped" style="width:80%;">
          <thead>
            <tr>
              ...
              <th class="text-center">
                UserName
                <a href="approvedusers.php?sort=ASC&val=user_name">
                  <p class="caret"></p>
                </a>
                <a href="approvedusers.php?sort=DESC&val=user_name">
                  <p class="caret caret-dropup"></p>
                </a>
              </th>
              <th class="text-center">
                Name
                <a href="approvedusers.php?sort=ASC&val=name">
                  <p class="caret"></p>
                </a>
                <a href="approvedusers.php?sort=DESC&val=name">
                  <p class="caret caret-dropup"></p>
                </a>
              </th>
              <th class="text-center">
                Mobile
                <a href="approvedusers.php?sort=ASC&val=mobile">
                  <p class="caret"></p>
                </a>
                <a href="approvedusers.php?sort=DESC&val=mobile">
                  <p class="caret caret-dropup"></p>
                </a>
              </th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="approvedusers.php?update=1&data=<?php echo $id; ?>" <?php if($data['isblock'] == "0" ) { ?>
