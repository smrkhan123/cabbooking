        ...
        <table class="table table-striped">
          <thead>
            <tr>
              ...
              <th class="text-center">
                Date
                <a href="pastrides.php?sort=ASC&val=ride_date">
                  <p class="caret"></p>
                </a>
                <a href="pastrides.php?sort=DESC&val=ride_date">
              ...
              <th class="text-center">
                Total Distance
                <a href="pastrides.php?sort=ASC&val=total_distance">
                  <p class="caret"></p>
                </a>
                <a href="pastrides.php?sort=DESC&val=total_distance">
                  <p class="caret caret-dropup"></p>
                </a>
              </th>
              ...
              <th class="text-center">
                Total Fare
                <a href="pastrides.php?sort=ASC&val=total_fare">
                  <p class="caret"></p>
                </a>
                <a href="pastrides.php?sort=DESC&val=total_fare">
                  <p class="caret caret-dropup"></p>
                </a>
              </th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="pastrides.php?ride=1&id=<?php echo $data['ride_id']; ?>"
                  class="btn btn-danger btn-xs">Remove</a>&nbsp;<a href="invoice.php?id=<?php echo $data['ride_id']; ?>"
