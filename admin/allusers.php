          ...
          <thead>
            <tr>
              ...
              <th class="text-center">
                UserName
                <a href="allusers.php?sort=ASC&val=user_name">
                  <p class="caret"></p>
                </a>
                <a href="allusers.php?sort=DESC&val=user_name">
                  <p class="caret caret-dropup"></p>
                </a>
              </th>
              <th class="text-center">
                Name
                <a href="allusers.php?sort=ASC&val=name">
                  <p class="caret"></p>
                </a>
                <a href="allusers.php?sort=DESC&val=name">
                  <p class="caret caret-dropup"></p>
                </a>
              </th>
              <th class="text-center">
                Mobile
                <a href="allusers.php?sort=ASC&val=mobile">
                  <p class="caret"></p>
                </a>
                <a href="allusers.php?sort=DESC&val=mobile">
                  <p class="caret caret-dropup"></p>
                </a>
              </th>
