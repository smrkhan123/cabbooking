  ...
  <div id="wrapper">
    ...
    <section id="main">
      <div class="text-center">
        ...
        <div class="container">
          <form action="cancelledrides.php" method="get" class="col-md-5 col-lg-5 text-left">
            Datewise:
          ...
          <form action="cancelledrides.php" method="get" class="col-md-4 col-lg-4 text-left">
            WeekWise:
          ...
          <form action="cancelledrides.php" method="get" class="col-md-3 col-lg-3 text-right">
            Cabwise: 
          ...
          <thead>
            <tr>
              ...
              <th class="text-center">
                Date
                <a href="cancelledrides.php?sort=ASC&val=ride_date&status=1">
                  <p
                    class="caret <?php if(isset($_GET['status'])){ if($_GET['status'] == 1) {?> caretStyle <?php ;} }?>">
                  </p>
                </a>
                <a href="cancelledrides.php?sort=DESC&val=ride_date&status=2">
                  <p
              ...
              <th class="text-center">
                Total Distance
                <a href="cancelledrides.php?sort=ASC&val=total_distance&status=3">
                  <p
                    class="caret <?php if(isset($_GET['status'])){ if($_GET['status'] == 3) {?> caretStyle <?php ;} }?>">
                  </p>
                </a>
                <a href="cancelledrides.php?sort=DESC&val=total_distance&status=4">
                  <p
              ...
              <th class="text-center">
                Total Fare
                <a href="cancelledrides.php?sort=ASC&val=total_fare&status=5">
                  <p
                    class="caret <?php if(isset($_GET['status'])){ if($_GET['status'] == 5) {?> caretStyle <?php ;} }?>">
                  </p>
                </a>
                <a href="cancelledrides.php?sort=DESC&val=total_fare&status=6">
                  <p
