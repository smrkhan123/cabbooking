  ...
  <div id="wrapper">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a href="pendingrides.php">Pending Rides</a></li>
    ...
    <section id="main">
      <div class="text-center">
        ...
        <div class="container">
          <form action="pendingrides.php" method="get" class="col-md-5 col-lg-5 text-left">
            Datewise:
          ...
          <form action="pendingrides.php" method="get" class="col-md-4 col-lg-4 text-left">
            WeekWise:
          ...
          <form action="pendingrides.php" method="get" class="col-md-3 col-lg-3 text-right">
            Cabwise: 
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="pendingrides.php?cancellride=1&id=<?php echo $data['ride_id']; ?>" class="btn btn-danger btn-xs">Cancel</a></td>
            </tr>
            <?php
                        if($data['status'] == '1'){
